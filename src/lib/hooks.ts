...
export const useTextMeasurement = (containerRef: RefObject<HTMLDivElement | null>) => {
...
export const useTypingStats = (startTime: number | null, totalKeystrokes: number, correctKeystrokes: number) => {
    return useCallback(() => {
